...
type CategoryDeleteToastProps = {
  category: ICategory;
  onCancel: () => void;
  onConfirm: () => void;
};

export default function CategoryDeleteToast({
  category,
  onCancel,
  onConfirm,
}: CategoryDeleteToastProps) {
  return (
    <div className="fixed bottom-6 right-6 z-50 w-full max-w-sm rounded-lg border border-gray-200 bg-white p-4 shadow-lg">
      <p className="text-sm text-gray-900">
        ...
        <span className="font-semibold">{category.catagoryName}</span>?
      </p>
